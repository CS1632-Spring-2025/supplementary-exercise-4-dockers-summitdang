...
public class D3Test {
  ...
  public void dEFECT2FUNGREETACAT() {
    ...
    assertThat(driver.findElement(By.xpath("//div[@id=\'greeting\']")).getText(), is("Meow!Meow!"));
  }
  //@Test
  public void dEFECT3FUNGREETACATWITHNAME() {
    ...
    assertThat(driver.findElement(By.xpath("//div[@id=\'greeting\']")).getText(), is("Jennyanydots is not here."));
  }
  @Test
  public void tEST1LINKS() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    {
      ...
      vars.put("store", attribute);
    }
    assertEquals("http://localhost:8080/reset", vars.get("store").toString());
  }
  @Test
